...
<div class="onepage" data-bs-spy="scroll" data-bs-target=".navbar-collapse .navbar-nav">
  <div class="content-wrapper">
    ...
    <section id="home">
      <div class="container vh-100 d-flex flex-column align-items-center justify-content-center" data-cues="zoomIn" data-group="hero">
        <h2 class="fs-16 ls-lg text-uppercase mb-5">Street & Nature Photographer</h2>
        <h1 class="display-1 mb-8">Kaylee Rosemary</h1>
        ...
        <div class="card">
          <div class="card-body">
            <div class="row gx-md-8 gx-xl-10 gy-8">
              <div class="col-lg-5">
                <figure class="rounded"><img class="img-fluid" src="./assets/img/photos/about.jpg" srcset="./assets/img/photos/about@2x.jpg 2x" alt=""></figure>
              </div>
              <!-- /column -->
              <div class="col-lg-7">
                <h2 class="mb-3">Life is an adventure. Capture every minute.</h2>
                <p class="lead mb-7">I'm Kaylee, a street and nature photographer. My passion is taking photos of the most stunning places around the world.</p>
                <div class="row">
                  <div class="col-lg-6">
                    <h3 class="h4 mb-3">A Little About Me</h3>
                    <p>
                      <span class="dropcap">N</span> ulla vitae elit libero, a pharetra augue. Dapuis mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Sed posuere consectetur est at lobortis. Fusce dapibus, tellus ac cursus.
                    </p>
                  </div>
                  <!-- /column -->
                  <div class="col-lg-6">
            ...
            <div class="grid grid-view">
              ...
              <div class="row gx-md-6 gy-6 isotope">
                <div class="item col-md-6 col-xl-4 drinks events">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p1-full.jpg" data-glightbox="title: Pellentesque Bibendum Vestibulum; description: Praesent commodo cursus magna, vel scelerisque nisl consectetur." data-gallery="g-portfolio"> <img src="./assets/img/photos/p1.jpg" srcset="./assets/img/photos/p1@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 events">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p2-full.jpg" data-glightbox="title: Porta Pellentesque Sem" data-gallery="g-portfolio"> <img src="./assets/img/photos/p2.jpg" srcset="./assets/img/photos/p2@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 drinks foods">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p3-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p3.jpg" srcset="./assets/img/photos/p3@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 events">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p4-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p4.jpg" srcset="./assets/img/photos/p4@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 pastries events">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p5-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p5.jpg" srcset="./assets/img/photos/p5@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 foods">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p6-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p6.jpg" srcset="./assets/img/photos/p6@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 foods drinks">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p7-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p7.jpg" srcset="./assets/img/photos/p7@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 pastries">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p8-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p8.jpg" srcset="./assets/img/photos/p8@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 events">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p9-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p9.jpg" srcset="./assets/img/photos/p9@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 foods">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p10-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p10.jpg" srcset="./assets/img/photos/p10@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 drinks">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p11-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p11.jpg" srcset="./assets/img/photos/p11@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 drinks">
                  <figure class="overlay rounded"><a href="./assets/img/photos/p12-full.jpg" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p12.jpg" srcset="./assets/img/photos/p12@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
                <div class="item col-md-6 col-xl-4 drinks events">
                  <figure class="overlay rounded"><a href="https://www.youtube.com/watch?v=rETpXdTbAzo" data-glightbox data-gallery="g-portfolio"> <img src="./assets/img/photos/p13.jpg" srcset="./assets/img/photos/p13@2x.jpg 2x" alt="" /></a>
                    <figcaption><i class="si-photo_aperture"></i></figcaption>
                  </figure>
                </div>
                <!-- /.item -->
        ...
        <div class="card">
          <div class="card-body">
              ...
              <div class="col-lg-4">
                ...
                <div class="d-flex flex-row">
                  ...
                  <div>
                    ...
                    <p class="mb-0"><a href="mailto:#" class="link-body">info@locus.com</a></p>
                  </div>
                </div>
              </div>
              <!--/column -->
            ...
            <div class="grid grid-view position-relative mb-10">
              <div class="position-absolute mt-3" style="top:50%; left: 50%; z-index:2; transform: translate(-50%,-50%);"><a href="#" class="btn btn-white"><i class="uil uil-instagram fs-18 me-1"></i> Follow Me</a></div>
